...
struct DataSeeder{
    static func seed(user: User) -> Bool {
        ...
        let welcomeBlock0 = Block(id: welcomeBlock0ID, type: BlockType.heading3, content: "Thanks for trying Graphnote", prev: nil, next: welcomeBlock1ID, graveyard: false, createdAt: now, modifiedAt: now, document: document0)
        let welcomeBlock1 = Block(id: welcomeBlock1ID, type: BlockType.heading3, content: "You can create a new document or edit this one!", prev: welcomeBlock0ID, next: welcomeBlock2ID, graveyard: false, createdAt: now, modifiedAt: now, document: document0)
        let welcomeBlock2 = Block(id: welcomeBlock2ID, type: BlockType.body, content: "Please reach out with any questions or feedback to graphnote.io@gmail.com", prev: welcomeBlock1ID, next: nil, graveyard: false, createdAt: now, modifiedAt: now, document: document0)
        ...
        let block0 = Block(id: block0ID, type: BlockType.body, content: "Hello Graphnote!", prev: nil, next: block1ID, graveyard: false, createdAt: now, modifiedAt: now, document: document1)
        let block1 = Block(id: block1ID, type: BlockType.body, content: "Thanks for stopping by!", prev: block0ID, next: block2ID, graveyard: false, createdAt: now, modifiedAt: now, document: document1)
        let block2 = Block(id: block2ID, type: BlockType.body, content: "Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.", prev: block1ID, next: nil, graveyard: false, createdAt: now, modifiedAt: now, document: document1)
        
        let document2 = Document(id: UUID(), title: "MVP", focused: nil, createdAt: now, modifiedAt: now, workspace: workspace.id)
        let block3 = Block(id: block3ID, type: BlockType.body, content: "The minimal viable product?", prev: nil, next: block4ID, graveyard: false, createdAt: now, modifiedAt: now, document: document2)
        let block4 = Block(id: block4ID, type: BlockType.body, content: "Hello Graphnote!", prev: block3ID, next: block5ID, graveyard: false, createdAt: now, modifiedAt: now, document: document2)
        let block5 = Block(id: block5ID, type: BlockType.body, content: "Hello Graphnote!", prev: block4ID, next: nil, graveyard: false, createdAt: now, modifiedAt: now, document: document2)
        
//        let blockEmpty = Block(id: UUID(), type: BlockType.empty, content: "", createdAt: now, modifiedAt: now, document: document3)
        let prompt0 = Block(id: UUID(), type: .body, content: "", prev: welcomeBlock2.id, next: nil, graveyard: false, createdAt: now, modifiedAt: now, document: document0)
        let prompt1 = Block(id: UUID(), type: .body, content: "", prev: block2.id, next: nil, graveyard: false, createdAt: now, modifiedAt: now, document: document1)
        let prompt2 = Block(id: UUID(), type: .body, content: "", prev: block5.id, next: nil, graveyard: false, createdAt: now, modifiedAt: now, document: document2)
